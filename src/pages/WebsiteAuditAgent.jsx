...
export default function WebsiteAuditAgent() {
  ...
  async function runAudit(e) {
    ...
    try {
      ...
      setError("No se ha podido ejecutar el Website Audit Agent.");
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-12 mt-10 max-w-4xl">
            ...
            <h1 className="mt-4 text-5xl font-semibold tracking-[-0.06em] md:text-7xl">
              Analyze a website like an AI growth consultant.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-400">
              Detecta problemas de diseño, UX, percepción premium, conversión y automatización.
            </p>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
            ...
            <Glass className="min-h-[520px] rounded-[2.3rem] p-6 md:p-8">
              <Globe className="mb-5 h-10 w-10 text-cyan-300" />
